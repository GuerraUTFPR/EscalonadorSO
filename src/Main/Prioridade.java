...
public class Prioridade {
    ...
    public void EscPrio(LinkedList<Processo> listaProcesso) {
        ...
        do {
            if (listaProcesso.size() > 0 && listaProcesso.getFirst().getTempoChegada().equals(tempo)) {//se existir processo na lista de processos e se o tempo de chegada do 1º processo for == tempo
